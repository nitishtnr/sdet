	...
	import io.appium.java_client.android.AndroidDriver;
			...
			public class Proj2_1 {
				...
				public void addTasks () throws InterruptedException {
					...
					MobileElement iTask = driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"taskInput\")"));
					MobileElement aTask = driver.findElementByXPath("//android.view.View/android.view.View[3]/android.view.View[1]/android.widget.Button");

					for (int i = 0; i<tasks.length; i++) {
						iTask.sendKeys(tasks[i]);
						aTask.click();	
					}
